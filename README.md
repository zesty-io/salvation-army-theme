...
- **`$spacer = 1`**
  ...
  - **`rounded-19`**: `$spacer * 6` - Maximum rounding, 600% of the spacer unit.### Custom Border Radius Classes Documentation

Custom border radius classes allow you to apply specific rounding to different corners of an element. Below are the classes and their corresponding properties for setting border radius in a modular way, using predefined spacer values.
